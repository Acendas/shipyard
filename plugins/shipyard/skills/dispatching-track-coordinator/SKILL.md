...
- The per-task verification spine is completely unchanged: sha exists, probe exit 0, non-empty tail, anti-stub-scan, anchor-commit, `task_dispatch_returned` — run here exactly as `dispatching-task-loop` already runs it.
